...
namespace ElectronCalculatorTests
{
    ...
    public class OhnValueCalculatorTest : IOhnValueCalculatorTests
    {
        ...
        public void BandAColorCodeTableLookupTest([ValueSource(typeof(OhnValueCalculatorTestData), "Colors")] ColorCodes x,
                                                   [ValueSource(typeof(OhnValueCalculatorTestData), "BandAPositiona")] Bands position,
        ...
        public void BandBColorCodeTableLookupTest([ValueSource(typeof(OhnValueCalculatorTestData), "Colors")] ColorCodes x,
                                                  [ValueSourceAttribute(typeof(OhnValueCalculatorTestData), "BandBPosition")] Bands position,
        ...
        public void BandCColorCodeTableLookupTest([ValueSource(typeof(OhnValueCalculatorTestData), "Colors")] ColorCodes x,
                                                  [ValueSource(typeof(OhnValueCalculatorTestData), "BandCPosition")] Bands position,
        ...
        public void BandDColorCodeTableLookupTest([ValueSource(typeof(OhnValueCalculatorTestData), "Colors")] ColorCodes x,
            [ValueSourceAttribute(typeof(OhnValueCalculatorTestData), "BandDPosition")] Bands position,
    ...
    public class OhnValueCalculatorTestData
    {
        ...
        public static Bands[] BandAPositiona()
        {
            return new Bands[]
            {
                Bands.SigDigA,
        ...
        //public static Bands[] BandBPosition()
        //{
        //    return new Bands[]
        //    {
        //        Bands.SigDigB,
        ...
        //public static Bands[] BandCPosition()
        //{
        //    return new Bands[]
        //    {
        //        Bands.MultiplierC,
        ...
        //public static Bands[] BandDPosition()
        //{
        //    return new Bands[]
        //    {

        //        Bands.ToleranceDPositive,
        //        Bands.ToleranceDPositive,
        //        Bands.ToleranceDPositive,
        //        Bands.ToleranceDPositive,
        //        Bands.ToleranceDPositive,
        ...
        //public static Bands[] BandDNegative()
        //{
        //    return new Bands[]
        //    {

        //        Bands.ToleranceDNegative,
        //        Bands.ToleranceDNegative,
        //        Bands.ToleranceDNegative,
        //        Bands.ToleranceDNegative,
        //        Bands.ToleranceDNegative,
